...
![index画面](assets/crud/books_index_data_22.png)
...
![Railsアプリがリクエストを受けてレスポンスを返すまで（indexアクション）](assets/crud/index_flow2.png)

今回のリクエストはindex（一覧）画面を表示するものです。上記の処理の後、ブラウザは受け取ったHTMLを私たちが見れる形で表示します。

![index画面](assets/crud/books_index_data_23.png)
